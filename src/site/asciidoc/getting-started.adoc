...
https://oss.sonatype.org/content/repositories/ksoap2-android-releases/com/google/code/ksoap2-android/ksoap2-android-assembly/3.6.2/ksoap2-android-assembly-3.6.2-jar-with-dependencies.jar 
